...
/// Singleton ApolloClient wired to the Firebase Functions /graphql endpoint.
/// Each request goes through:
///   1. FirebaseTokenInterceptor — injects Authorization: Bearer <Firebase ID Token>
...
final class GraphQLClient: @unchecked Sendable {
    ...
    var apollo: ApolloClient {
        let url = SharedConfig.serverURL.appendingPathComponent("graphql")
