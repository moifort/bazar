...
/// user owns, and the buying of it. Every purchase ends the same way — the signed
...
final class SubscriptionStore {
    ...
    /// The UUID a purchase must carry so the server can tie it to this user. It
    ...
    /// Buy one of the offers. Returns true when the user came out of it Premium.
    @discardableResult
    func purchase(_ product: Product) async -> Bool {
        ...
        do {
            ...
            case .success(let verification):
                ...
                // Premium, saying nothing is the one thing we must not do: the user
    ...
    /// us it does not check out. Returns whether the user came out of it Premium,
