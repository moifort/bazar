#!/usr/bin/env bash
#
# Build, install and launch the Bazar app on the physical iPhone
...
DEVICE_ID="00008130-000A2068029A001C" # TiPhone junior
...
APP="build/device/Build/Products/Debug-iphoneos/Bazar.app"
