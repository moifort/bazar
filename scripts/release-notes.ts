...
/// Two changelogs, two audiences: the French one is what the App Store shows a user,
...
if (command) {
  ...
  if (command === 'guard') {
    const project = readFileSync(resolve(root, 'ios/Bazar.xcodeproj/project.pbxproj'), 'utf8')
